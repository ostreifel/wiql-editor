 ...
 */
function getSuggestions(ctx: ICompletionContext, position: monaco.Position): Q.IPromise<monaco.languages.CompletionItem[]> {
    ...
    if (ctx.fieldRefName && ctx.isInCondition) {
        ...
        const inString = ctx.parseNext.errorToken instanceof Symbols.NonterminatingString;
